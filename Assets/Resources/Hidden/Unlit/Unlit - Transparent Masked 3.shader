...
void main()
{
    ...
    //Instruction 152
    //MAD
    t0.x = in_POSITION0.x * _ClipArgs2.w + (-t0.x);
    //Instruction 153
    //DP2
    t0.y = dot(in_POSITION0.xy, _ClipArgs2.zw);
    //Instruction 154
    //MAD
    vs_TEXCOORD3.xy = t0.xy * _ClipRange2.zw + _ClipRange2.xy;
    //Instruction 155
    //MOV
    vs_COLOR0 = in_COLOR0;
    //Instruction 156
...
void main()
{
    ...
    //Instruction 129
    //ADD
    t2.xy = -abs(vs_TEXCOORD3.xy) + vec2(1.0, 1.0);
    //Instruction 130
    //MUL
