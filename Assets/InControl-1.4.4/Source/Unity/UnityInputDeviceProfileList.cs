namespace InControl
{
	...
	public class UnityInputDeviceProfileList : ScriptableObject
	{
		public static readonly string[] Profiles = new string[]
		{
			...
			"InControl.BetopBTP2175sWinProfile",
			...
			"InControl.EightBitdoGenericAndroidProfile",
			"InControl.EightBitdoN30Pro2AndroidProfile",
			...
			"InControl.GoogleStadiaMacUnityProfile",
			"InControl.GoogleStadiaProfile",
			"InControl.GoogleStadiaWindowsUnityProfile",
			"InControl.GreenThrottleAtlasAndroidProfile",
			"InControl.HamaBlackForceWinProfile",
			"InControl.HavitHVG95WLinuxProfile",
			"InControl.IpegaPG9021AndroidProfile",
			"InControl.IpegaPG9023AndroidProfile",
			"InControl.IpegaPG9025AndroidProfile",
			"InControl.IpegaPG9037AndroidProfile",
			"InControl.IpegaPG9055AndroidProfile",
			...
			"InControl.NintendoSwitchProMacChromeUnityProfile",
			"InControl.NintendoSwitchProWindowsChromeUnityProfile",
			...
			"InControl.NVidiaShieldWin81Profile",
			...
			"InControl.PlayStation2LinuxProfile",
			...
			"InControl.PlayStation4MacChromeUnityProfile",
			"InControl.PlayStation4MacFirefoxUnityProfile",
			"InControl.PlayStation4MacUSBProfile",
			"InControl.PlayStation4Profile",
			"InControl.PlayStation4SteamLinkMacProfile",
			"InControl.PlayStation4WindowsChromeUnityProfile",
			"InControl.PlayStation4WindowsFirefoxUnityProfile",
			...
			"InControl.Xbox360MacChromeUnityProfile",
			"InControl.Xbox360MacFirefoxUnityProfile",
			"InControl.Xbox360MacProfile",
			"InControl.Xbox360MacSafariUnityProfile",
			"InControl.Xbox360RockCandyAndroidProfile",
			"InControl.Xbox360WinProfile",
			"InControl.XboxOneBluetoothAndroidProfile",
			"InControl.XboxOneMacChromeUnityProfile",
			"InControl.XboxOneMacFirefoxUnityProfile",
			"InControl.XboxOneMacProfile",
			"InControl.XboxOneMacSafariUnityProfile",
			...
			"InControl.XInputWindowsChromeUnityProfile",
			"InControl.XInputWindowsFirefoxUnityProfile",
