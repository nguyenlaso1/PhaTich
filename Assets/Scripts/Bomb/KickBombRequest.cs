// @sonhg: class: Bomb.KickBombRequest
using System;
...
namespace Bomb
{
	public class KickBombRequest : global::BaseRequest
	{
		public KickBombRequest(int old_x, int old_y, int new_x, int new_y)
		{
			this.old_x = old_x;
			this.old_y = old_y;
			this.new_x = new_x;
		...
		protected override IRequest Request
		{
			get
			{
				...
				sfsobject.PutUtfString("task", "kick-bomb");
