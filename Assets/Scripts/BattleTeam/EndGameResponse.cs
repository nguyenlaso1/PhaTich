// @sonhg: class: BattleTeam.EndGameResponse
using System;
	...
	public class EndGameResponse : BaseResponse
	{
		public override void UpdateBusiness()
		{
			...
			foreach (object obj in sfsarray)
			{
				...
				endGamePanel.FillSlot(num, utfString, int6, int5, @int, int2, int3, int4, int4 == SmartFoxConnection.Connection.MySelf.Id, true);
				num++;
			}
		}
