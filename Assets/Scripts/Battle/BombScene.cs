...
namespace Battle
{
	...
	public class BombScene : BombGameScene
	{
    static Dictionary<string, int> _003C_003Ef__switch_0024map8;
		...
		public override void OnExtensionResponse(BaseEvent evt)
		{
			...
			if (text2 != null)
			{
				if (BombScene._003C_003Ef__switch_0024map8 == null)
				{
					BombScene._003C_003Ef__switch_0024map8 = new Dictionary<string, int>(1)
					{
						{
							"s-map",
							0
				...
				int num;
				if (BombScene._003C_003Ef__switch_0024map8.TryGetValue(text2, out num))
				{
					if (num == 0)
					{
